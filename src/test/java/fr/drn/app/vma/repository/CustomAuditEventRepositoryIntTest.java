...
import fr.drn.app.vma.config.audit.AuditEventConverter;
import fr.drn.app.vma.domain.PersistentAuditEvent;
...
import static fr.drn.app.vma.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
