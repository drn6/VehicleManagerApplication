...
describe('Service Tests', () => {
    ...
    describe('VehicleTaskVma Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VehicleTaskVmaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vehicle-tasks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VehicleTaskVma', () => {
