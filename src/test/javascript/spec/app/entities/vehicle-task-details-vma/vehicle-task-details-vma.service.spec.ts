...
describe('Service Tests', () => {
    ...
    describe('VehicleTaskDetailsVma Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VehicleTaskDetailsVmaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vehicle-task-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VehicleTaskDetailsVma', () => {
